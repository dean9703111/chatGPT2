# Ch11 工程師福音！讓 ChatGPT 來協助 Code Review、Refactoring、Comments

### 11.1 直接把程式碼丟進 ChatGPT 會發生什麼事？
...
### 11.2	讓 ChatGPT 用中文解釋程式（Review and explain）

`Review code and explain in traditional Chinese [List of points]`

### 11.3 用 ChatGPT 重構程式（Refactoring）
...
### 11.4 用 ChatGPT 幫程式加上註解（Comments）
...
### 參考資料
1.	[ChatGPT Refactor 後的程式](https://github.com/dean9703111/chatGPT2/blob/master/Ch11/myproject/refactor-index.js)
2.	[ChatGPT Refactor 並加上註解的程式](https://github.com/dean9703111/chatGPT2/blob/master/Ch11/myproject/commemt-index.js)